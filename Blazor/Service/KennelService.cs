...
public class KennelService : IKennelService
{
    ...
    public KennelService()
    {
        _dogs = new List<Dog>
        {
            new(1, "Nika", "female", "labrador", new DateOnly(2021, 1, 21), "a friendly dog",
            ...
            new(2, "Nika", "male", "labrador", new DateOnly(2021, 1, 21), "a friendly dog",
                "https://plus.unsplash.com/premium_photo-1668114375111-e90b5e975df6?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
            new(3, "Nika", "female", "labrador", new DateOnly(2001, 1, 21), "a friendly dog",
                "https://plus.unsplash.com/premium_photo-1668114375111-e90b5e975df6?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
            new(4, "Nika", "female", "labrador", new DateOnly(2001, 1, 21), "a friendly dog",
                "https://plus.unsplash.com/premium_photo-1668114375111-e90b5e975df6?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
            new(5, "Nika", "male", "labrador", new DateOnly(2000, 1, 21), "a friendly dog",
